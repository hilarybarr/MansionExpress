...
# mansions=(1..50).to_a
# 50.times do
#   derek.mansions << Mansion.find(mansions.shift)
# end



# antonio=User.create(name: "Antonio Swagger", email:"antonio@swagger.com", password: "igeekallweek")
# # fahia.personality_traits << software
# # fahia.personality_traits << PersonalityTrait.where(name:"in an open relationship").first
# mansions=(50..100).to_a
# 50.times do
#   antonio.mansions << Mansion.find(mansions.shift)
# end
